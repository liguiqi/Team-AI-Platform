...
- 负责把 LibreChat 的标准 OpenAI 请求转发到智谱、DeepSeek 等真实上游。
...
5. `NEW-API` 根据匹配到的渠道配置，把请求转发到智谱、DeepSeek 等真实上游。
...
### 上游密钥
- 变量名：`ZHIPU_API_KEY`、`DEEPSEEK_API_KEY`
